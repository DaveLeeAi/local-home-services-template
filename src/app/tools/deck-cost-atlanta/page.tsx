    ...
    return (
        <div className="bg-slate-50 min-h-screen">
            ...
            <Container className="py-12">
                ...
                {/* Direct Answer Block (AE/GEO Optimized) */}
                <div className="bg-slate-50 border-l-4 border-primary p-6 md:p-8 rounded-r-xl mb-12 max-w-4xl mx-auto shadow-sm">
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">How much does a deck cost in Atlanta?</h2>
                    <div className="prose prose-slate max-w-none text-gray-700">
                        <p className="mb-4">
                            In Metro Atlanta, homeowners typically pay <strong>$25–$35 per square foot</strong> for pressure-treated wood decks and <strong>$45–$60+ per square foot</strong> for composite or PVC decking, both fully installed.
                        </p>

                        <div className="grid md:grid-cols-2 gap-6 mb-6 not-prose">
                            <div className="bg-white p-4 rounded-lg border shadow-sm">
                                <h3 className="font-bold text-lg mb-1">Pressure-Treated Wood</h3>
                                <p className="text-2xl font-bold text-primary mb-1">$25–$35<span className="text-sm font-normal text-gray-500">/sq ft</span></p>
                                <p className="text-xs text-muted-foreground">Budget-friendly upfront but requires annual maintenance</p>
                            </div>
                            <div className="bg-white p-4 rounded-lg border shadow-sm">
                                <h3 className="font-bold text-lg mb-1">Composite/PVC</h3>
                                <p className="text-2xl font-bold text-primary mb-1">$45–$60+<span className="text-sm font-normal text-gray-500">/sq ft</span></p>
                                <p className="text-xs text-muted-foreground">Higher initial cost, minimal upkeep</p>
                            </div>
                        </div>

                        <p className="mb-4">
                            <strong>Permit Costs:</strong> Most Metro Atlanta counties (Gwinnett, Cobb, Fulton) require structural permits, typically adding <strong>$150–$400</strong> to your project.
                        </p>

                        <div className="bg-amber-50 rounded-lg p-4 border border-amber-100 flex gap-3">
                            <div className="shrink-0 pt-1">💡</div>
                            <div>
                                <strong className="block text-amber-900 mb-1">Pro Tip:</strong>
                                <span className="text-amber-800 text-sm">Georgia&apos;s intense humidity and heat accelerate wood rot and warping. While composite materials cost more initially, they eliminate annual staining, sealing, and board replacement—often paying for themselves within 7–10 years through reduced maintenance and longer lifespan in our climate.</span>
                            </div>
                        </div>

                        <p className="mt-6 font-medium text-gray-900 border-t pt-4">
                            Ready to get an accurate estimate? Use our calculator below to see what your specific deck project will cost.
                        </p>
                    </div>
                </div>
