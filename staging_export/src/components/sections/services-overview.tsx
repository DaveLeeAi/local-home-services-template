            ...
            <Container>
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl text-primary">
                        Expert Deck Services for Atlanta Homeowners
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {services.map((service) => (
                        <div key={service.title} className="flex flex-col items-start p-6 bg-slate-50 rounded-2xl border border-slate-100 hover:shadow-lg transition-shadow">
                            ...
                            <Link href={service.href} className="text-sm font-semibold text-primary hover:text-primary/80 flex items-center">
