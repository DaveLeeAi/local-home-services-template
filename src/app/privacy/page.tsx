                ...
                <main className="flex-1 py-16 bg-white">
                    <Container className="prose prose-slate max-w-3xl">
                        ...
                        <p><strong>Peachtree Outdoor Living</strong><br />
                            ...
                            Email: privacy@peachtreeoutdoor.com</p>
                    </Container>
                </main>
            </div>
        </div>
