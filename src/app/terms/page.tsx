            ...
            <div className="flex min-h-screen flex-col">
                <main className="flex-1 py-16 bg-white">
                    <Container className="prose prose-slate max-w-3xl">
                        ...
                        <p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the peachtreeoutdoor.com website (the "Service") operated by Peachtree Outdoor Living ("us", "we", or "our").</p>
