                ...
                <Container>
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl border border-slate-200">
                            <Image
                                src="/images/portfolio-repair.png" // Using repair specific image
            ...
            <section id="pergolas" className="py-24 bg-white scroll-mt-20">
                <Container>
                    <div className="text-center mb-16 max-w-3xl mx-auto">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6">Pergolas & Covered Porches</h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {/* Cedar Pergolas */}
                        <div className="group rounded-2xl overflow-hidden border border-slate-200 shadow-lg hover:shadow-xl transition-all">
                            <div className="relative h-64 overflow-hidden">
                                <Image
                                    src="/images/cedar-pergola.png"
                                    alt="Cedar Pergola Design"
                                    fill
                            ...
                            <div className="p-8">
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    Classic open-beam aesthetic casting dappled shade. Perfect for vines and adding architectural character to your backyard.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="group rounded-2xl overflow-hidden border border-slate-200 shadow-lg hover:shadow-xl transition-all">
                            <div className="relative h-64 overflow-hidden">
                                <Image
                                    src="/images/screened-porch.png"
                                    alt="Custom Screened Porch"
                                    fill
                                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                                />
                            </div>
                            <div className="p-8">
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    Enjoy the breeze without the mosquitoes. We utilize high-visibility screening and durable aluminum framing systems.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="group rounded-2xl overflow-hidden border border-slate-200 shadow-lg hover:shadow-xl transition-all">
                            <div className="relative h-64 overflow-hidden">
                                <Image
                                    src="/images/covered-patio.png"
                                    alt="Luxury Covered Patio"
                                    fill
                                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                                />
                            </div>
                            <div className="p-8">
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    Full roof structures for rain-or-shine enjoyment. Features include vaulted ceilings, recessed lighting, and fan installations.
                                </p>
                            </div>
                        </div>
                    </div>
